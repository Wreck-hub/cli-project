...
# 80-90 % are on the basis of CRUD

# git config--global user.name "Shekhar Limbu"
# git config--global user.email "wreck.limbu1996@gmail.com"
...
def delete_users(con):
    ...
    con.commit()
    print("All users were Delete succesfully")
    ...
    if con:
        ...
        if user_input == "1":
            ...
            for column in COLUMNS:
                column_value = input("Enter the value of {}: ")
            ...
            confirmation = input("Are your sure want to delete all users (y/n): ")
